...
import static kdxhttp3.internal.Util.equal;
 ...
 *   at kdxhttp3.CertificatePinner.check(CertificatePinner.java)
 *   at kdxhttp3.Connection.upgradeToTls(Connection.java)
 *   at kdxhttp3.Connection.connect(Connection.java)
 *   at kdxhttp3.Connection.connectAndSetOwner(Connection.java)
 * }</pre>
 *
